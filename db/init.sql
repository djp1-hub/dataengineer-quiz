...
INSERT INTO public.quiz_questions (question,answer_options,correct_answer,rating) VALUES
	 ('Какие стратегии используются для обработки медленно меняющихся измерений (SCD) в хранилище данных?','1. Создание новой строки с историей изменений,2. Перемещение данных в архив,3. Использование индексов для отслеживания изменений,4. Дублирование таблиц для хранения истории,5. Сжатие данных и хранение в бинарном формате','1. Создание новой строки с историей изменений','6'),
