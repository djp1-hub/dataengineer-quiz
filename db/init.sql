...
INSERT INTO public.quiz_questions (question,answer_options,correct_answer,rating) VALUES
	 ('Какие стратегии используются для обработки медленно меняющихся измерений (SCD) в хранилище данных?','Тип 1 Перезапись,Тип 2 Добавление новой строки,Тип 3 Добавление нового столбца,Тип 4 Использование таблицы истории,Тип 6 Гибрид (типы 1 + 2 + 3)','Все из них','За каждый по 1 баллу'),
...
INSERT INTO public.quiz_questions (question,answer_options,correct_answer,rating) VALUES
	 ...
	 ('Какой тип индексирования используется в ClickHouse для ускорения поиска по столбцам?','1. Primary Key,2. Full-Text Index,3. Sparse Index,4. Data Skipping Index','3. Sparse Index (3 балла)','3');
